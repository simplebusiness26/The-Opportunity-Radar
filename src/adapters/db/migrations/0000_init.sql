...
CREATE TYPE "public"."actor_kind" AS ENUM('user', 'system', 'job');--> statement-breakpoint
...
CREATE TABLE "users" (
	...
	"password_algo" text DEFAULT 'scrypt-n32768-r8-p1' NOT NULL,
...
CREATE INDEX "secrets_workspace_kind_idx" ON "secrets" USING btree ("workspace_id","kind","name");