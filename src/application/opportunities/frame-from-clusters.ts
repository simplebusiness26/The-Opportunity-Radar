 ...
 *
 * This is intentionally conservative and non-decisive. A system actor may
 * frame a hypothesis, but the opportunity still begins at `detected` and
 * cannot enter execution without the normal owner-only decision gate.
 *
 * The opportunity type is provisionally `new_product` because this path must
 * work without AI. Investigation can later reclassify the solution form.
 */
